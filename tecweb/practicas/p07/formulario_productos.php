...
<head>
    ...
    </style>  <body style="background-color:grey;">
</body>
...
<body>
    <div id="form">
        <form method="POST" action="http://localhost/tecnologiasweb/practicas/p06-base/set_producto_v2.php"
            ...
            <ul>
                ...
                <li>Detalles: <br>
                    <textarea name="detalles" rows="3" cols="50" id="detalles"
                        placeholder="No más de 250 caracteres de longitud" onBlur="verificarD(this)"></textarea>
                    <br><br>
